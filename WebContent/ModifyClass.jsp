...
ArrayList<String> rooms = data.getAllRooms();
			...
			<div class="row">
				...
				<div
					...
					<div class="wrapper" id="form-wrapper">
						<div class="inner">
							<form id="booking-form" method="post" action="ModifyClassServlet">
								<h3>Modify Classroom Form</h3>
								<div class="form-group">
									<div class="form-wrapper">
										<label for="">All Classrooms</label>
										<div class="box">
											<select name = "AllRooms">
											<%
